        ...
        <nav className="bg-gray-300 border-green-950 p-4 shadow-md border-b ">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <Link href="/" className="text-black hover:text-green-950 relative before:content-[''] before:absolute before:w-full before:h-0.5 before:bottom-0 before:left-0 before:bg-green-900   before:scale-x-0 before:transition-transform before:duration-300 hover:before:scale-x-100">
                        About
                    </Link>
