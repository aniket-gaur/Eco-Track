...
const AnimatedHeroSection = () => {
    ...
    return (
        <section ref={heroRef} className="relative  bg-gradient-to-b from-[#6B8E23] to-[#2F4F2F] py-20 h-full overflow-hidden">
            <div className="container mx-auto flex flex-col md:flex-row items-center justify-between ">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900 ">Your Eco-Friendly</h2>
